...
/**
 * compara ambos lados y verifica si son distintos E -> E != E
 *
 * @author gio
 */
public class Diferencia extends Instruccion {

    // atributos expresion izq y derecha
    private Instruccion expIzq;
    private Instruccion expDer;

    public Diferencia(Instruccion expIzq, Instruccion expDer, int linea, int columna) {
