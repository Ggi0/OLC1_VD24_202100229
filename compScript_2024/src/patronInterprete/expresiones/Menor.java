...
/**
 * E -> E<E para los booleanos se toma true como 1 y false como 0 para las
 * cadenas no se toma en cuenta el resto se toma su valor numerico o valor en la
 * tabla ascii @author gio
 */
public class Menor extends Instruccion {
    ...
    public Menor(Instruccion expIzq, Instruccion expDer, int linea, int columna) {
